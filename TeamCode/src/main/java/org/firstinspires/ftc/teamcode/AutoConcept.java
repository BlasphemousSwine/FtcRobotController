...
@Autonomous (name = "LeftBlue", preselectTeleOp = "IdahoTeleOp")
public class AutoConcept extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        state state = AutoConcept.state.START;
        ...
        while(opModeIsActive()) {
            ...
            switch(state) {
                ...
                case START:
                    ...
                    drivetrain.setPosition[2] = 220;
                    drivetrain.setPosition[1] = 0.45;
                    lift.drop();
                    if (i >= 100) {
                        i = 0;
                        state = AutoConcept.state.EXTEND;
                    } else {
                        i++;
                    }
                ...
                case EXTEND:
                    ...
                    if (i >= 50) {
                        i = 0;
                        state = AutoConcept.state.RETRACT;
                    } else {
                        i++;
                    }
                ...
                case RETRACT:
                    ...
                    drivetrain.setPosition[2] = 270;
                    drivetrain.setPosition[0] = 2;

                    if (i >= 100) {
                        i = 0;
                        state = AutoConcept.state.WAREHOUSE;
                    }
                    else {
                        i++;
                    }
